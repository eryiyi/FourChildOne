...
//		}
	...
	public void onSaveInstanceState(Bundle outState) {
	    ...
	    if((( com.easemob.chatuidemo.activity.MainActivity)getActivity()).isConflict){
	    	outState.putBoolean("isConflict", true);
	    }else if(((com.easemob.chatuidemo.activity.MainActivity)getActivity()).getCurrentAccountRemoved()){
