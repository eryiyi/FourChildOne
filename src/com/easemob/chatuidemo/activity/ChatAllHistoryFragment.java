...
//		((MainActivity) getActivity()).updateUnreadLabel();
	...
	public void onResume() {
		super.onResume();
		if (!hidden && ! ((com.xiaogang.Mine.MainActivity)getActivity()).isConflict) {
			refresh();
		}
	}
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(((com.xiaogang.Mine.MainActivity)getActivity()).isConflict){
        	outState.putBoolean("isConflict", true);
        }else if(((com.xiaogang.Mine.MainActivity)getActivity()).getCurrentAccountRemoved()){
    ...
    public void onClick(View v) {
		switch (v.getId()){
			case R.id.friends:
				Intent friendsV = new Intent(getActivity(), com.easemob.chatuidemo.activity.MainActivity.class);
