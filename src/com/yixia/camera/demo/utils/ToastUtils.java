...
public class ToastUtils {
	...
	public static void showToast(int resID) {
		showToast(UniversityApplication.getContext(), Toast.LENGTH_SHORT,
				resID);
	}

	public static void showToast(String text) {
		showToast(UniversityApplication.getContext(), Toast.LENGTH_SHORT, text);
	}
	...
	public static void showLongToast(int resID) {
		showToast(UniversityApplication.getContext(), Toast.LENGTH_LONG, resID);
	}
	...
	public static void showLongToast(String text) {
		showToast(UniversityApplication.getContext(), Toast.LENGTH_LONG, text);
	}
