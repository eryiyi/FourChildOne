...
import com.xiaogang.Mine.ui.PublishVideoActivity;
...
public class VideoPlayerActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		UniversityApplication.getInstance().addActivity(this);
		// 防止锁屏
...
//			ToastUtils.showLongToast("视频地址：" + mPath);
			Intent videoMine = new Intent(VideoPlayerActivity.this, PublishVideoActivity.class);
			videoMine.putExtra("path", mPath);
			startActivity(videoMine);
			finish();
			// UniversityApplication.getInstance().exit();
			break;
		case R.id.videoview:
			if (mVideoView.isPlaying())
				mVideoView.pause();
