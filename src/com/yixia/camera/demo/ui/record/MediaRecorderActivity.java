...
public class MediaRecorderActivity extends BaseActivity implements
	...
	private void startRecord() {
		...
		mRebuild = true;
		mPressedStatus = true;
		mRecordController.setImageResource(R.drawable.video_record_btn_video_record_p);
	...
	private void stopRecord() {
		...
		mRecordController.setImageResource(R.drawable.video_record_btn_video_record);
