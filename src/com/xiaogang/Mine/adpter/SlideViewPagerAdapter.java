...
public class SlideViewPagerAdapter extends PagerAdapter {
    ...
    public SlideViewPagerAdapter(Context cx, List<Integer> paths) {
        mContext = cx;
        this.mPaths = paths;
    }
...
//    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        holder.iv.setImageResource(mPaths.get(position));
//        imageLoader.displayImage(InternetURL.INTERNAL_PIC + mPaths.get(position), holder.iv, UniversityApplication.options,animateFirstListener);
