...
//        imageLoader.displayImage(mPaths.get(position).getNewsPic(), holder.iv, PropertyApplication.options,animateFirstListener);
        holder.iv.setImageResource(mPaths.get(position).getPic());
