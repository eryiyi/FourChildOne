...
import com.xiaogang.Mine.util.SecureValidate;
import com.xiaogang.Mine.util.WaitDialog;
import com.xiaogang.Mine.widget.PagesGallery;

/**
 * 简单实时预览界面
 * 
 */
public class SimpleRealPlayActivity extends BaseActivity implements OnClickListener, SurfaceHolder.Callback,
        OnItemSelectedListener, Handler.Callback, OnTouchListener, SecureValidate.SecureValidateListener, OpenYSService.OpenYSServiceListener {
    /** 打印标签 */
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        if (mSelectedRealPlayerHolder == null) {
            mSelectedRealPlayerHolder = (SimpleRealPlayerAdapter.RealPlayerHolder) v.getTag();
            if (mSelectedRealPlayerHolder != null) {
                // 开始播放
                startRealPlay();
            }
